			...
			<main class="main">
				<div class="content_position">
					...
					<div class="articles">
						<?php 
							$limitCount = 9;
							$countAllArticles = Controllers\User\Post::getPostsCount('news');
							if ( $countAllArticles > 0 ) {
								$items = Controllers\User\Post::getPosts('news', array('article_date', 'DESC'),  $limitCount, 0);
		...
		<script>
			...
			$('.loadmore').click(function(){
				...
				$.ajax({
					...
					method: 'post',
					dataType: 'json',
					data: { action: 'getPosts', type: 'news', limit: articleLimit, offset: articleOffset },
