...
$pageTree = 'Категории';
$all_categories= Controllers\Admin\Category::view();
?>
<!DOCTYPE html>
							...
							<h1>Все категории</h1>
								...
								<div class="table-wrapper dolphron-elements">
									<table>
										<thead>
											<tr>
												<th style="min-width: 180px">Категория</th>
												<th style="min-width: 400px">Единица измерения</th>
										...
										<tbody>
											...
											<tr>
												<td><?php echo($cat->category_value_ru); ?></td>
												<td><?php echo($cat->category_unit); ?></td>
